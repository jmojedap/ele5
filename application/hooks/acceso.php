...
class Acceso {
    ...
    function funciones_publicas()
    {
        ...
        $funciones_publicas[] = 'app/video_inicio';
        $funciones_publicas[] = 'app/video';

        $funciones_publicas[] = 'app/login_form';
        $funciones_publicas[] = 'app/cvalidate_login';
        ...
        $funciones_publicas[] = 'orders/cancel';
