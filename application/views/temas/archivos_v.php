...
new Vue({
    ...
    methods: {
        get_list: function() {
            axios.get(this.app_url + 'temas/get_archivos/' + this.tema_id)
                .then(response => {
        ...
        save_archivo: function() {
            axios.post(this.app_url + 'temas/save_archivo/' + this.tema_id + '/' + this.archivo_id, $('#archivo_form').serialize())
                .then(response => {
        ...
        delete_element: function() {
            axios.get(this.app_url + 'temas/delete_archivo/' + this.tema_id + '/' + this.archivo_id)
                .then(response => {
