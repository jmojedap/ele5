...
<form accept-charset="utf-8" method="POST" id="search_form" @submit.prevent="get_list">
    ...
    <div id="adv_filters" style="<?php echo $filters_style ?>">
        <div class="form-group row">
            <div class="col-md-9">
                <?php echo form_dropdown('f1', $options_city, $filters['f1'], 'class="form-control form-control-chosen" title="Filtrar por ciudad"'); ?>
            </div>
            <label for="f1" class="col-md-3 control-label col-form-label">Ciudad</label>
        </div>
    </div>
</form>