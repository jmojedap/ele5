<div class="row">
    <div class="col col-md-7">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo base_url($destination_form) ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <div class="form-group row">
                        <label for="file" class="col-md-3 text-right col-form-label">Archivo</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        <div class="col-md-9 offset-md-3">
                            <button type="submit" class="btn btn-primary w120p">Importar</button>
                        </div>
                    </div>
                </form>
            </div>
