    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detail_modal_label">{{ element.nombre_grupo }}</h5>
            ...
            <div class="modal-footer">
                    <a class="btn btn-primary w100p" v-bind:href="`<?php echo base_url('grupos/index/') ?>` + element.id">Abrir</a>
