<p>
    ...
    <span class="resaltar"><span class="etiqueta nivel w1"><?= $row->nivel ?></span></span> |
    <span class="suave">Código:</span>
    <span class="resaltar"> <?= $row->cod_pregunta ?></span> |
    <span class="suave">Tema:</span>
    <span class="resaltar"> <?= anchor("temas/preguntas/{$row->tema_id}", $this->App_model->nombre_tema($row->tema_id)) ?></span> |
    <span class="suave">Componente:</span>
    <span class="resaltar"> <?= $this->App_model->nombre_item($row->componente_id) ?></span> |
    <span class="suave">Competencia:</span>
    <span class="resaltar"> <?= $this->App_model->nombre_item($row->competencia_id) ?></span> |
    <span class="suave">Proceso de pensamiento:</span>
    <span class="resaltar"> <?= $row->proceso_pensamiento ?></span> |
</p>
<p>
    <?= $row->notas ?>
</p>
