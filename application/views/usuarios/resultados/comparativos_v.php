...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                Resumen por temas / competencias
            </div>
            <table class="table table-responsive">
                <thead>
                    <th>Nombre tema</th>
    ...
    <div class="col-md-6">
        <div class="panel panel-default">
            <div class="panel-heading">
                Detalle preguntas por competencia
            </div>
            <table class="table table-responsive bg-blanco" cellspacing="0">
                <thead>
                    <tr>
                        <th width="40px">#</th>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            <td class="<?= $clase_fila ?> text-center">
                                <?= $contador_pregunta ?>
                            </td>
