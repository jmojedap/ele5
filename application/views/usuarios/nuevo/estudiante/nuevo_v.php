<div id="app_add">
    <div class="container">
        ...
        <div class="card" v-show="form_values.institucion_id > 0 && form_values.grupo_id == 0">
            <div class="card-body">
                <h3 class="card-title">Seleccione el grupo de {{ institucion.nombre_institucion }}</h3>
                <table class="table bg-white">
                    ...
                    <tbody>
                        <tr v-for="(grupo, key) in grupos">
                            ...
                            <td>{{ grupo.anio_generacion }}</td>
                            <td>
                                <button class="btn btn-primary" v-on:click="set_grupo(key)">
                                    Seleccionar
                                </button>
                            </td>
                        </tr>
        ...
        <div class="card" v-show="form_values.grupo_id > 0">
            <div class="card-body">
                <form accept-charset="utf-8" method="POST" id="add_form" @submit.prevent="validate_send">
                    ...
                    <input name="grupo_id" class="d-none" v-model="form_values.grupo_id">
                    <fieldset v-bind:disabled="loading">
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="grupo" class="col-md-4 col-form-label text-right">Grupo</label>
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" v-model="grupo.nombre_grupo" disabled>
                                    <div class="input-group-append">
                                        <button class="btn btn-primary" type="button" v-on:click="unset_grupo">Cambiar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $this->load->view('usuarios/nuevo/estudiante/vue_v') ?>