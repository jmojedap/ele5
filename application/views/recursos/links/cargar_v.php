...
<?= form_open_multipart("recursos/procesar_cargar_links", $att_form) ?>

<div class="seccion group">
    
    <div class="col col_box span_1_of_3">
        <div class="info_container_body">
            <h4>Instrucciones para cargar lista links</h4>
            <ul>
                ...
                <li>Descargar formato: <?= anchor(base_url() . 'assets/formatos_cargue/06_formato_cargue_links.xlsx', '06_formato_cargue_links.xlsx', 'class="" title="Descargar formato"') ?> </li>
            </ul>
        </div>
    </div>
    ...
    <div class="col col_box span_2_of_3">
        <div class="info_container_body">      
            ...
            <div class="div1">
                ...
                <input type="text" name="nombre_hoja" value="links" class="i-texto1" required>
            </div>
