    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detail_modal_label">Link {{ element.id }}</h5>
            ...
            <div class="modal-footer">
                <a class="btn btn-primary w3" v-bind:href="`<?php echo base_url('temas/links/') ?>` + element.tema_id">Abrir</a>
