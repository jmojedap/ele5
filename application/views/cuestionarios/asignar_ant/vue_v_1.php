        ...
        methods: {
            ...
            enviar_formulario: function() {
                ...
                .then(response => {
                    ...
                    {
                        this.grupo_id = this.valores_form.grupo_id;
                        this.obtener_lista();
            ...
            eliminar_elemento: function(key) {
                this.elemento_actual(key);
                var evento_id = this.lista[key].id;
                ...
                .then(response => {
                    ...
                    if ( response.data.ejecutado == 1 )
                    {
                        this.lista.splice(this.row_key, 1);
            ...
            cargar_formulario: function(key) {
                ...
                var row = this.lista[this.row_key]
                ...
                console.log(this.lista[this.row_key].grupo_id);
            },
