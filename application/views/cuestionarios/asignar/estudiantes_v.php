...
<div class="form-group row">
    <label for="seleccionados" class="col-md-4 control-label">
        <span class="float-right">seleccionados</span>
    </label>
    <div class="col-md-8">
        <input
            id="campo-seleccionados"
            name="seleccionados"
            class="form-control"
    ...
    <tbody>
        <?php foreach ($estudiantes->result() as $row_estudiante) : ?>
            <?php
                ...
                $link_responder = anchor("cuestionarios/resolver_lote/$row_estudiante->uc_id", '<i class="fa fa-pencil-square-o"></i>', 'class="btn btn-default btn-sm"');
                ...
                //Checkbox
                    ...
                    $att_check['data-usuario_id'] = $row_estudiante->usuario_id;
            ?>
                ...
                <td>
                    ...
                    <?php if (in_array($this->session->userdata('rol_id'), $roles_editar)) { ?>
                        <?php if ($row_estudiante->estado > 1) { ?>
                            ...
                            <button class="btn btn-sm btn-warning btn_reiniciar_uc" data-uc_id="<?php echo $row_estudiante->uc_id ?>">
