...
<?php
    ...
    $att_nombre_flipbook = array(
        ...
        'value' => 'Contenido - ' . $row->nombre_programa . ' - ' . date('Y-M-d h:i:s'),
        'class' =>  'form-control'
    );
    
    $att_descripcion = array(
        'name'  =>  'descripcion',
        'value' => 'Contenido re-creado a partir del programa: ' . $row->nombre_programa . ', creado el ' . date('Y-M-d h:i'),
        'class' =>  'form-control',
        'rows' =>   3
    );
    ...
    $att_flipbook_id = 'id="flipbook_id"';
?>
...
<div class="row">
    <div class="col col-sm-5" style="min-height: 500px;">
            ...
            <div class="panel-body">
                ...
                <?= form_open($destino_form, $att_form) ?>
                    <div class="form-group">
                        <label for="nombre_flipbook" class="col-sm-3 control-label">Sobreescribir el Contenido</label>
                        <div class="col-sm-9">
                            <?= form_dropdown('flipbook_id', $opciones_flipbook, '', 'class="form-control chosen-select"') ?>
                        </div>
                    </div>
                    <div class="form-group">
