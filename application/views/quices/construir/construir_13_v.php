            ...
            <div class="panel-body">
                ...
                <table class="tabla-transparente" width="100%">
                    <tbody>
                        ...
                        <?= form_hidden('id_alfanumerico', $id_alfanumerico) ?>
                        <?= form_hidden('quiz_id', $row->id) ?>
                        <?= form_hidden('tipo_id', 1) //Tipo de quiz ?>
                        <?= form_hidden('orden', $row->cant_elementos) ?>
                        <?= form_hidden('clave', $row->cant_elementos) ?>
