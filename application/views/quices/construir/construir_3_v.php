<?php
    ...
    $att_texto = array(
        ...
        'id' => 'texto',
        'rows' => 4,
        'placeholder' => 'Escriba aquí el enunciado',
        'class' => 'form-control'
        
    );
    
    $opciones[0] = 'Falso';
    $opciones[1] = 'Verdadero';
    
    //Imagen
        $carpeta_quices = RUTA_UPLOADS . 'quices/';
        $att_img = array(
                ...
                <table class="tabla-transparente" width="100%">
                    <tbody>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <span class="btn btn-primary w4" id="guardar_elemento">Agregar</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <?php foreach ($elementos_quiz->result() as $row_elemento) : ?>
                    <div id="elemento_<?= $row_elemento->id_alfanumerico ?>">
                        ...
                        <p>
                            ...
                            <span class="etiqueta exito w3"><?= $opciones[$row_elemento->clave] ?></span> 
                        </p>
