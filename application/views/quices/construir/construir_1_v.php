...
<div class="row">
        ...
        <div class="card card-default">
            <div class="card-body">
                ...
                <div class="mb-2">
                    ...
                    <?php } else { ?>
                        <?= $this->Pcrn->anchor_confirm("quices/eliminar_archivo/{$quiz_id}/{$imagenes->row()->id_alfanumerico}", '<i class="fa fa-trash"></i> Eliminar', 'class="btn btn-warning" title="Eliminar imagen"', '¿Confirma la eliminación de esta imagen?') ?>
    ...
    <div class="col-md-8">
        ...
        <div class="card card-default" id="elementos">
            ...
            <?php endforeach ?>
            <p>
                <span class="btn btn-info w4" id="nuevo_elemento">Nuevo</span>
            </p>
            </div>
        </div>
    </div>
