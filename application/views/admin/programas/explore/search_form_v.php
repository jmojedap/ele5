<form accept-charset="utf-8" method="POST" id="searchForm" @submit.prevent="getList">
    ...
    <div class="grid-columns-15rem mb-3">
        ...
        <div>
            <label for="i">Institución</label>
            <select name="i" v-model="filters.i" class="form-control form-control-chosen">
                <option v-for="(optionInstitution, idInstitucion) in optionsInstitucion" v-bind:value="idInstitucion">{{ optionInstitution }}</option>
            </select>
        </div>
