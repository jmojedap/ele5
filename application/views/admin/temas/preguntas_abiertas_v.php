...
new Vue({
    ...
    methods: {
        get_list: function() {
            axios.get(this.app_url + 'admin/temas/get_pa/' + this.tema_id)
                .then(response => {
        ...
        save_pa: function() {
            axios.post(this.app_url + 'admin/temas/save_pa/' + this.tema_id + '/' + this.pa_id, $('#pa_form').serialize())
                .then(response => {
        ...
        delete_element: function() {
            axios.get(this.app_url + 'admin/temas/delete_pa/' + this.tema_id + '/' + this.pa_id)
                .then(response => {
