...
new Vue({
    ...
    methods: {
        get_list: function() {
            axios.get(this.app_url + 'admin/temas/get_links/' + this.tema_id)
                .then(response => {
        ...
        save_link: function() {
            axios.post(this.app_url + 'admin/temas/save_link/' + this.tema_id + '/' + this.link_id, $('#link_form').serialize())
                .then(response => {
        ...
        delete_element: function() {
            axios.get(this.app_url + 'admin/temas/delete_link/' + this.tema_id + '/' + this.link_id)
                .then(response => {
                    if ( response.data.status == 1 ) {
