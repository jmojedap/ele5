...
<div id="order_user_app" class="center_box_450">
    ...
    <div v-show="show_success_register">
        ...
        <a href="<?php echo base_url("orders/compra_a/") ?>" class="btn btn-main btn-block">
    ...
    <div v-show="show_existing">
        ...
        <a href="<?php echo base_url("orders/compra_a/") ?>" class="btn btn-main btn-lg btn-block">
            CONTINUAR
        </a>
    </div>
</div>
...
<script>
    new Vue({
        ...
        methods: {
            ...
            set_user: function(){
                axios.get(app_url + 'orders/set_user/' + this.user.id)
                .then(response => {
                    console.log(response.data)
                })
                .catch(function (error) {
