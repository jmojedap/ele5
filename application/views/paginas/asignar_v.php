...
<?php $this->load->view('paginas/menu_v') ?>

<?= form_open_multipart("paginas/procesar_asignar", $att_form) ?>
    ...
    <div class="col col_box span_1_of_3">
        <div class="info_container_body">
            ...
            <ul>
                ...
                <li>Si el nombre de archivo de imagen ya se encuentra asignado al tema, no se duplicará, pero sí se editará el orden según los datos del archivo de Excel.</li>
            </ul>
        </div>
    </div>
